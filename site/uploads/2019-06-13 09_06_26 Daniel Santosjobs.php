...
$stmt = $db -> prepare("insert into fund (date,name,email,phone,year,job,presentention,cv) values('".$datai."','".$_POST['name']."','".$_POST['email']."','".$$_POST['phone']."','".$_POST['year']."','".$_POST['job']."','".$_POST['presentention']."','".$target_file."')");
if( $stmt -> execute() ){
	echo "Row Inserted";
}else{
